...
function OnDay()
	if player:get_value("Kawaii_AMTS_Active") == "true" then
		...
		EditPoint(getDP())
		cmsg("cyan", "Points increased by " .. getDP() .. ". Total points: " .. AMTS_Point)
...
-- ■新規プレイヤー
function Init()
	cmsg("light_green", "The air in front of me began to shimmer, and then a fancy-looking metal box appeared in front of me. What is is...?")
